...
**Group work from [Seili-2019](https://github.com/oercompbiomed/Seili-2019), then focusing on prostate cancer, can be found on Overleaf [[here](https://www.overleaf.com/project/5ec71af71aca320001385354)] and on this repo as  [[main.tex](./main.tex)]  [[fig1](./Fig1_The_process_of_autoEncoder.png)] [[fig2](./Fig2_Overview_of_the_process.png)] resulting in [[pdf](./Seili_2020_project_template.pdf)]**
